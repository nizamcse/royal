...
@section('content')
    <div class="box">
        <div class="box-header">
            <h2><strong>MATERIAL PURCHASE ORDER </strong>(Purchase Date : <strong>{{ \Carbon\Carbon::parse($material_purchase_order->purchase_date)->toFormattedDateString() }}</strong>)</h2>
        </div>
    </div>
    <div class="box">
        <div class="box-header">
    ...
    <div class="box">
        ...
        @if(count($material_purchase_order->otherMaterials))
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">OTHER MATERIAL DETAILS</h3>
                </div>
                <div class="box-body">
                    <table class="table table-bordered list-table">
                        <thead>
