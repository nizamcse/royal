...
{{--            {{ dd(route('vendor-profile', ['company_id' => Request::segment(2),'id' => ''])) }}--}}
            {{--, vendorProfileUri='{{ route('vendor-profile', ['company_id' => Request::segment(2),'id' => '']) }}' , deleteVendorUri='{{ route('delete-vendor',['company_id' => Request::segment(2),'id' => '']) }}' , getVendorsUri= '{{ route('getVendors',['company_id' => Request::segment(2)]) }}'--}}
            <show-vendor :items="{  vendorProfileUri:'{{ route('vendor-profile', ['company_id' => Request::segment(2),'id' => '']) }}', deleteVendorUri:'{{ route('delete-vendor',['company_id' => Request::segment(2),'id' => '']) }}', getVendorsUri:'{{ route('getVendors',['company_id' => Request::segment(2)]) }}' }"></show-vendor>
