...
@section('content')
    <div class="box">
        <div class="box-header">
            <h2><strong>SALES ORDER </strong>(Sold Out Date : <strong>{{ \Carbon\Carbon::parse($sales_order->sold_out_date)->toFormattedDateString() }}</strong>)</h2>
        </div>
    </div>
    <div class="box">
        <div class="box-header">
        ...
        <div class="box-body">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td><strong>Customer Contact No.: </strong>{{ $sales_order->customer ? $sales_order->customer->contact_no : $sales_order->contact_no }} </td>
                </tr>
            </table>
        </div>
    </div>
