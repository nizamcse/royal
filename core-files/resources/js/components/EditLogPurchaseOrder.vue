    ...
    <div>
        <div class="box">
            <div class="box-header">
                <h2><strong>EDIT LOG PURCHASE ORDER</strong></h2>
            </div>
        </div>
        <div class="box">
            <div class="box-header">
...
<script>
    export default {
        props: ['token','log_purchase_order','routes'],
        ...
        methods: {
            ...
            initLogPurchaseOrder(){
                const order = this.log_purchase_order;
                this.vendor = {
                    id: order.vendor.id,
                    name: order.vendor.name,
                    address: order.vendor.address,
                    contactNo: order.vendor.contact_no,
                };
                this.challanNoMannual = order.challan_no_mannual;
                this.additionalChallanNoMannual = order.additional_challan_no_mannual;
                this.purchaseDate = order.purchase_date;
                this.existingProperty = {
                    purchase_order_id: order.id,
                    vendor_id: order.vendor.id,
                    challan_no_mannual: order.challan_no_mannual,
                    additional_challan_no_mannual: order.additional_challan_no_mannual,
                    purchase_date: order.purchase_date,
                };
                order.logs.forEach(element => {
