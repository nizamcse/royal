            ...
            <div class="col-md-4">
                <div class="box" style="min-height: 495px">
                    <div class="box-header">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"  v-model="advance_search">Advance Search
                            </label>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            searchItem: function () {
                ...
                if(this.searchedText.length){
                    if(this.advance_search){
                        ...
                        this.itemCollections = this.products.filter((item) => {
                            const name = item.name.toUpperCase().slice(0,this.searchedText.length);
                            return name === this.searchedText.toUpperCase();
                        });
                    }
                }else{
