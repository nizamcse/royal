    ...
    <div>
        <div class="box">
            <div class="box-header">
                <h2><strong>EDIT MATERIAL PURCHASE ORDER</strong></h2>
            </div>
        </div>
        <div class="box">
            <div class="box-header">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-right">
                            <button class="btn btn-success" :disabled="updatingOrder" @click="updateOrder()" >{{ updatingOrder ? "Updating Order ..." : "UPDATE ORDER"}}</button>
                        </div>
                    </div>
                </div>
...
<script>
    export default {
        props: ['token', 'routes', 'materialPurchaseOrder'],
        data: function () {
            return {
                ...
                updateJsonPurchaseOrderRoute: null,
        ...
        methods: {
            ...
            updateOrder(){
                ...
                const route = this.updateJsonPurchaseOrderRoute+"/"+this.existingProperty.purchase_order_id;
            ...
            initMaterialPurchaseOrder(){
                const materialPurchaseOrder = this.materialPurchaseOrder;
                if(Object.keys(materialPurchaseOrder).length === 0){
                    return;
                }
                this.vendor = {
                    id: materialPurchaseOrder.vendor.id,
                    name: materialPurchaseOrder.vendor.name,
                    address: materialPurchaseOrder.vendor.address,
                    contactNo: materialPurchaseOrder.vendor.contact_no,
                };
                this.challanNoMannual = materialPurchaseOrder.challan_no_mannual;
                this.additionalChallanNoMannual = materialPurchaseOrder.additional_challan_no_mannual;
                this.purchaseDate = materialPurchaseOrder.purchase_date;
                this.existingProperty = {
                    purchase_order_id: materialPurchaseOrder.id,
                    vendor_id: materialPurchaseOrder.vendor.id,
                    challan_no_mannual: materialPurchaseOrder.challan_no_mannual,
                    additional_challan_no_mannual: materialPurchaseOrder.additional_challan_no_mannual,
                    purchase_date: materialPurchaseOrder.purchase_date,
                };
                materialPurchaseOrder.materials.forEach(element => {
        ...
        created(){
            ...
            this.updateJsonPurchaseOrderRoute = this.routes.updateJsonPurchaseOrder;
            this.initVendors();
            this.initMaterials();
            if (this.materialPurchaseOrder){
                this.initMaterialPurchaseOrder()
            }
        },
        computed:{
            hasVendor(){
            ...
            enableAddButton(){
                if(this.materialType == 1 && this.addableMaterialItem.amount){
                    return  true;
