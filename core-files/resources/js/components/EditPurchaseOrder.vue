<template>
    <div class="search-form p-15">
        <div class="row cyan-bg">
            ...
            <div class="col-md-3">
                <div class="form-group" style="color:#000">
                    ...
                    <datepicker input-class="form-control" :value="dateInput" :format="formatDate"></datepicker>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" v-model="additionalPurchaseChalanNo">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
        ...
        <div class="row" v-if="productType == 2">
            <form action="#" method="post" v-on:submit.prevent="addRowMaterialItem" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Unit</label>
                        <input type="text" v-model="rawMaterial.unit_name" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Price/Unit</label>
                        <input type="text" class="form-control" v-model="rawMaterial.price_per_unit" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Amount</label>
                        <input type="text" class="form-control" :value="price_per_unit" readonly>
                    </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="row" v-else-if="productType == 3">
            <form action="#" v-on:submit.prevent="addOtherItem" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false">
                <div class="col-md-4">
                    <div class="form-group search-form-group">
                        <label>Material Name</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Unit</label>
                        <input type="text" v-model="otherItem.unit_name" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Price/Unit</label>
                        <input type="text" class="form-control" v-model="otherItem.price_per_unit" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
        ...
        <div class="row" v-else>
            <form action="#" v-on:submit.prevent="addLogItem" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false">
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Radius</label>
        ...
        <form :action="formUrl" method="post" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false">
            ...
            <input type="hidden" name="additional_challan_no_mannual" :value="additionalPurchaseChalanNo">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered list-table">
                        ...
                        <tr v-for="(rawMaterialItem,index) in rawMaterialItems">
                            ...
                            <th>{{ rawMaterialItem.unit_name }}</th>
                            <th>{{ rawMaterialItem.price_per_unit }} <input type="hidden" :name="'raw_material['+ index +'][price_per_unit]'" :value="rawMaterialItem.price_per_unit"></th>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered list-table">
                        ...
                        <tr v-for="(rawMaterialItem,index) in otherMaterialItems">
                            ...
                            <th>{{ rawMaterialItem.unit_name }}</th>
                            <th>{{ rawMaterialItem.price_per_unit }}<input type="hidden" :name="'raw_material['+ (index + rawMaterialItems.length) +'][price_per_unit]'" :value="rawMaterialItem.price_per_unit"></th>
                    ...
                    <table class="table table-bordered list-table">
                        ...
                        <tr v-for="(item,index) in logItems">
                            ...
                            <td>
                                ...
                                <input type="hidden" :name="'log['+ index +'][category_id]'" :value="item.category_id">
                            </td>
                            ...
                            <td>
                                {{ item.total_price }}
                                <input type="hidden" :name="'log['+ index +'][price_per_unit]'" :value="item.price_per_unit">
                            </td>
            ...
            <div class="col-md-12">
                <div class="form-group text-right">
                    <button type="submit" class="btn btn-sm btn-success" :disabled="!logItems.length && !otherMaterialItems.length && !rawMaterialItems.length ">UPDATE PURCHASE</button>
                </div>
            </div>
        </form>
    ...
    export default {
        ...
        computed: {
            ...
            price_per_unit: function(){
                let p = this.rawMaterial.price_per_unit ? parseFloat(this.rawMaterial.price_per_unit) : 0;
                let q = this.rawMaterial.quantity ? parseFloat(this.rawMaterial.quantity) : 0;
                return parseFloat(p*q).toFixed(2);
            },
            totalAmount: function () {
                let p = this.otherItem.price_per_unit ? parseFloat(this.otherItem.price_per_unit) : 0;
        ...
        methods: {
            ...
            selectRawMaterial(item){
                ...
                this.rawMaterial.unit_name = item.unit_name;
                this.rawMaterial.quantity = null;
                this.rawMaterial.price_per_unit = null;
                this.searchResults = [];
            },

            addRowMaterialItem(){
                let item = this.rawMaterial;
                item.amount = this.price_per_unit;
            ...
            selectOtherItem(item){
                ...
                this.otherItem.unit_name = item.unit_name;
                this.otherItem.quantity = null;
                this.otherItem.price_per_unit = null;
                this.otherItemResults = [];
            },
            ...
            getPurchaseOrderData(){
                ...
                axios.get(app.apiUrl)
                    .then(response => {
                        ...
                        app.dateInput = response.data.date;
                        app.purchaseDate = response.data.date;
                        app.purchaseChalanNo = response.data.chalanNo;
        ...
        created: function() {
            ...
            this.categories = this.items.categories ? this.items.categories : [];
            this._token = this.items.token;
            this.formUrl = this.items.formUrl;
